...
// Copyright (c) 2019, The Next Gen Coin Developers
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x4d101;
...
const uint64_t MINIMUM_FEE                                   = UINT64_C(0.00016);
